...
description: "IA générative et contentieux OHADA : entre outils concrets (Jurisprudence.cc, Maathis) et défis de souveraineté numérique. Analyse par GSF Consulting International."
---
...
1. **Couche données** : agrégation des corpus jurisprudentiels OHADA dans un data lake souverain hébergé localement (sur le modèle des data centers inaugurés au Burkina Faso en janvier 2026)
2. **Couche modèles** : fine-tuning de LLMs open-source sur le corpus OHADA, avec clés de chiffrement détenues localement
3. **Couche applicative** : interfaces métier (prédiction de succès, scoring de créances, génération d'actes) accessibles aux praticiens via un portail sécurisé
...
1. Jurisprudence.cc, *"Plateforme d'IA juridique panafricaine"*, lancement octobre 2025
2. Maathis, *"Dialoguer avec la jurisprudence OHADA"*, 2025
3. Jimini AI, *"Raisonnement agentique pour la rédaction juridique"*, sélection État français, septembre 2025
...
7. Village de la Justice, *"Confidentialité, secret, protection des données et IA dans la procédure arbitrale"*, 2024
