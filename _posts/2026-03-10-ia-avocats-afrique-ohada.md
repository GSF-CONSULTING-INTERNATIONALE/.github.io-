...
1. L'IA remplace une partie des tâches standardisées, mais pas le rôle professionnel complet.
2. Les avocats qui sauront s'approprier l'IA remplaceront ceux qui la refusent.
3. La vigilance éthique et déontologique est impérative.
4. L'IA est un outil d'accès à la justice, pourvu qu'elle reste sous contrôle professionnel.
